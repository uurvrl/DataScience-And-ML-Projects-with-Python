...
df = pd.read_csv("salary_prediction_model/hitters.csv")
...
############################
# REMOVING THE MISSING VALUES FROM THE TABLE
############################

# Because missing values are from the target value, It is better to remove missing values rather than other options.
...
df_null = df[df["Salary"].isnull()]  # Separating the null values in the salary.
df.dropna(inplace=True)  # Remove missing values in salary
